...
function detectLang() {
    ...
    if (l.startsWith("zh_tw") || l.startsWith("zh-tw") || l.startsWith("zh_hk") || l.startsWith("zh-hk"))
        return "zh-TW";
    if (l.startsWith("zh"))
        return "zh-CN";
    return "en";
...
const MESSAGES = {
    linkGuide: {
        "zh-CN": (link) => `请点击下方链接创建你的 GMGN API Key，完成后将 Key 发给我，我来帮你完成配置：\n${link}`,
        "zh-TW": (link) => `請點擊下方連結建立你的 GMGN API Key，完成後將 Key 發給我，我來幫你完成配置：\n${link}`,
        en: (link) => `Please click the link below to create your GMGN API Key. Once created, send me the API Key and I will finish the configuration:\n${link}`,
    },
    verifySuccess: {
...
function writeEnv(apiKey, privatePem) {
