 ...
 */
export function detectAlgorithm(pem) {
 ...
 */
export function buildMessage(subPath, queryParams, body, timestamp) {
 ...
 */
export function sign(message, privateKeyPem, algorithm) {
